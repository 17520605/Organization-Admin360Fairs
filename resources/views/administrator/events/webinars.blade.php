...
@section('content')
    <div class="container-fluid tags-wrapper">
        <h1 class="h3 text-gray-800"> <span id="page-title">All Events</span> <button class="btn btn-df" style="position: absolute; right: 1.5rem;"><a href="/administrator/tours/{{$tour->id}}/events/webinars/create"><i class="fas fa-upload" style="margin-right: 8px;"></i> Add new event</a></button></h1>
