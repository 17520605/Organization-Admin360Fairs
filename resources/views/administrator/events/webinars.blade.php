...
@section('content')
    <div class="container-fluid ">
        ...
        <div class="tab-header mb-3" style="width: 100%; height: 40px; mb-2 ">
            <span id="tab-event-btn-line" class="btn btn-primary float-left active" data-tab="table"><i class="fas fa-stream"></i></span>
            <span id="tab-event-btn-card" class="btn btn-primary float-left " data-tab="card"><i class="fas fa-clone"></i></span>
        </div>
