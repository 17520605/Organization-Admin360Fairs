                            ...
                            @endphp
                                <div class="single-timeline-area">
                                    <div class="timeline-date wow fadeInLeft" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInLeft;">
                                        <p class="font-weight-bold">{{$time->format('d')}} - {{$time->format('M')}} -  {{$time->format('Y')}}</p>
                                    </div>
                                    <div class="row">
                                            ...
                                            @if ($webinar->registerBy == $profile->id)
                                                ...
                                                <div class="col-12">
                                                    <a href="/administrator/tours/{{$tour->id}}/events/webinars/{{$webinar->id}}" class="btn-page-loader single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft;">
                                                        ...
                                                        <img src="https://res.cloudinary.com/virtual-tour/image/upload/v1638859834/icons/top-rated_yocfvl.png" style="position: absolute;width: 100px;right: 10px; top: 10px" alt="">
                                                    </a>
                                                </div>
                                            @else  
